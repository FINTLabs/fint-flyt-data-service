...
public class KlassifikasjonstypeConsumer {
    ...
    @Bean
    String klassifikasjonstypeTopicName(TopicNameService topicNameService) {
        return topicNameService.generateEntityTopicName("arkiv.kodeverk.klassifikasjonstype");
    }

    @KafkaListener(topics = "#{klassifikasjonstypeTopicName}")
