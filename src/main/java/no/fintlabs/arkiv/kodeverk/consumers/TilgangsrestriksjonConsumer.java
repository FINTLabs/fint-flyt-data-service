...
public class TilgangsrestriksjonConsumer {
    ...
    @Bean
    String tilgangsrestriksjonTopicName(TopicNameService topicNameService) {
        return topicNameService.generateEntityTopicName("arkiv.kodeverk.tilgangsrestriksjon");
    }

    @KafkaListener(topics = "#{tilgangsrestriksjonTopicName}")
